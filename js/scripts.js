var repository = (function() {
 ...
 function loadList(url) {
  //loads first page information from api
  if (!url) {
   url = apiUrl;
  }
  return $.ajax(url, {
   ...
   //recursive function loads through all pages to get info from api
   if (response.info.next) {
    return loadList(response.info.next).then(function(items) {
   ...
   //gets last page info + characters
